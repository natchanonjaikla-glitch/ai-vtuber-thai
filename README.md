...
### ความสามารถ
- **ค้นเว็บ** — ถามเรื่องข่าว/ราคา/เหตุการณ์ล่าสุด ไอริสจะไปค้น DuckDuckGo มาสรุปให้
  (พิมพ์ "ค้นหา ..." หรือให้โมเดลตัดสินใจเองผ่านมาร์กเกอร์ `[[SEARCH: ...]]`)
- **สีหน้า/อารมณ์** — โมเดลเลือกอารมณ์เองผ่าน `[[EMOTION: happy]]` อวตารทำสีหน้าตาม
  มีกะพริบตาและขยับหัวเบา ๆ ตอนอยู่เฉยด้วย
- **ปากตามสระ** — วิเคราะห์ฟอร์แมนต์จากเสียงจริงเพื่อขึ้นรูปปากเป็น อา/อี/อู/เอ/โอ
  ไม่ใช่แค่อ้า-หุบตามความดัง
